...
def command_help():
    commands_description = [
        ...
        (
            ...
            "Include a birthday for a contact.",
        ),
        (
            "add_email",
        ...
        (
            "change_note",
            "change-note [title] [new_content] [new_tags]",
        ...
        (
            ...
            "Remove a specific email address from a contact.",
        ),
        (
            "del_birthday",
            "del_birthday [name] [birthday]",
        ...
        (
            "del_contact",
            "del-contact [name]",
            "Remove a specific contact from the Address Book.",
        ),
        ...
        (
            "show_birthday",
            "show-birthday [name]",
            "Show the birthday of a specific contact.",
        ),
        (
            "show_email",
            "show-email [name]",
            "Display the email addresses of a specific contact.",
        ),
        (
            "show_upcoming_birthdays",
            "birthdays [quantity_of_days]",
            "List upcoming birthdays within a specified number of days.",
        ),
        (
            "show_address",
            "show-address [name]",
            "View the address associated with a contact.",
        ),
