...
from console.colorizer import Colorizer
from console.file_operations import read_contacts, write_contacts
from console.command_logger import read_commands_log
...
def command_help():
    commands_description = [
        ...
        ("add-contact", "add-contact [name] [phone]", "Create a new contact or add an additional phone number to an existing one."),
        ("all-contacts", "all-contacts", "List all contacts in the Address Book."),
        ("change-contact", "change-contact [name] [field] [old_value] [new_value]", "Modify contact details like phone, email, name, or birthday."),
